...
const categories = ["ssd", "headPhone", "tv", "phone", "memory", "smartWatch", "camera", "celular", "mouse", "keyborad"];
		...
		>
			...
			<form onSubmit={handleSubmit} className='space-y-4'>
				...
				<button
					...
					shadow-sm text-sm font-medium text-white bg-blue-400 hover:bg-blue-500 
